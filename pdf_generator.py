                ...
                for memory in decade_memories:
                    ...
                    if paragraphs:
                        story_content.append(
                            Paragraph(paragraphs[0], styles["MagazineBody"])
                        )
                    ...
                    if pull_quote_text and len(paragraphs) > 1:
                        ...
                        pull_quote_table = Table(
                            [[pull_quote_para]], colWidths=[5 * inch]
                        )
                        pull_quote_table.setStyle(
                            TableStyle(
                                [
                    ...
                    if related_images:
                        ...
                        if os.path.exists(img_path):
                            try:
                                ...
                                img = Image(
                                    img_path, width=max_width, height=target_height
                                )
                                img.hAlign = "CENTER"
                                ...
                                # Caption
                                caption_text = (
                                    related_images[0][4] or related_images[0][2]
                                )
                                if related_images[0][5]:  # description
                                    caption_text += f" - {related_images[0][5]}"
                                story_content.append(
                                    Paragraph(caption_text, styles["PhotoCaption"])
                                )
                                story_content.append(Spacer(1, 0.1 * inch))
                    ...
                    if len(related_images) > 1:
                        ...
                        if os.path.exists(img_path):
                            try:
                                ...
                                caption_text = (
                                    related_images[1][4] or related_images[1][2]
                                )
                                story_content.append(
                                    Paragraph(caption_text, styles["PhotoCaption"])
                                )
