    ...
    try:
        ...
        if api_key:
            ...
            if age is not None:
                ...
                context = f"The person was {age} years old ({life_phase} phase) in {year}. "
            elif year:
...
Respond with ONLY the category name, nothing else."""
            ...
            valid_categories = [
                'childhood', 'teenage', 'young-adult', 'education', 'work', 
                'music', 'family', 'travel', 'military', 'hobbies', 
                'life-event', 'family-history', 'other'
            ]
    ...
    if age is not None:
        ...
        elif age <= 12 and any(word in text_lower for word in ['born', 'baby', 'child', 'primary school']):
            return 'childhood'
        elif 13 <= age <= 19 and any(word in text_lower for word in ['secondary school', 'high school', 'gcse', 'a-level']):
            return 'teenage'
    
    # Keyword-based categorization (prioritized by specificity)
    categories = [
        ("family-history", ['before i was born', 'my mother was born', 'my father was born', 'my grandmother', 'my grandfather']),
        ("music", ['band', 'bass', 'guitar', 'drums', 'singer', 'gig', 'concert', 'musician', 'rehearsal', 'played in', 'performed']),
        ("military", ['army', 'navy', 'air force', 'military', 'service', 'soldier', 'regiment', 'deployed', 'enlisted']),
        ("work", ['worked at', 'job', 'career', 'employed', 'serving', 'manager', 'company', 'office', 'colleague', 'boss', 'garage', 'petrol station', 'hired', 'salary']),
        ("education", ['school', 'college', 'university', 'teacher', 'student', 'class', 'exam', 'degree', 'studying', 'graduated', 'claverham', 'primary']),
        ("life-event", ['was born', 'birth', 'married', 'wedding', 'died', 'funeral', 'graduated', 'retired', 'moved house']),
        ("family", ['mother', 'father', 'parent', 'sibling', 'daughter', 'son', 'wife', 'husband', 'sister', 'brother', 'uncle', 'aunt', 'cousin']),
        ("travel", ['traveled', 'trip', 'vacation', 'holiday', 'journey', 'visited', 'abroad', 'flew to', 'drove to']),
        ("hobbies", ['hobby', 'sport', 'fishing', 'cycling', 'running', 'painting', 'photography', 'played football', 'played cricket'])
    ]
